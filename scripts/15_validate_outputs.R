...
# canônica em scripts/phase2/16_validate.R. A versão anterior validava a estrutura
...
cat("Delegando para scripts/phase2/16_validate.R ...\n\n")

source(here("scripts", "phase2", "16_validate.R"))
